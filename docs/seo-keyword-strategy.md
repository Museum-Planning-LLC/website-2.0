...
| 2026-05-05 | Competitor matrix CSV (primary + extended keywords); experiential cohort rows Gallagher LP Ideum Quatrefoil plus JRA/RWS + Design and Production turnkey museum cohort. |
